    	...
    	if(K!=i) {
            ...
            if (distancia <= dist_limite){
            	///Entra a la sumatoria
              	...
              	double aux = c_p*(((dist_opti*dist_opti)-(dist_opti*distancia))/(distancia*distancia*distancia));
				aux *= exp((distancia)/(dist_opti));
              	aux *= (sol[i][T].r_x-sol[K][T].r_x)/distancia;
              	sumatoria+=aux;
            }
        }
    }
    	...
    	if(K!=i) {
            ...
            if (distancia <= dist_limite){
            	///Entra a la sumatoria
              	...
              	double aux = c_p*(((dist_opti*dist_opti)-(dist_opti*distancia))/(distancia*distancia*distancia));
				aux *= exp((distancia)/(dist_opti));
              	aux *= (sol[i][T].r_y-sol[K][T].r_y)/distancia;
              	sumatoria+=aux;
            }
        }
    }
